          ...
          <Card className="shadow-xl mb-12">
            <CardContent className="p-8">
              ...
              <div className="prose prose-lg max-w-none text-slate-700">
                ...
                <p className="mb-4">
                  Your home is likely your largest asset—let's make it work harder for you. Unlike big banks that push their own products, I work exclusively for you, comparing rates and terms from 200+ lenders to find the perfect solution for your unique situation.
                </p>
                <p className="mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Unlike banks that only offer their products, I shop your loan with 200+ lenders to find the best rates and terms.
                  </p>
                </div>
                <div className="text-center">
