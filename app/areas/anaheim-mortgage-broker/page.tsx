      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-blue-50 p-8 rounded-2xl">
            ...
            <div className="mt-6 p-4 bg-white rounded-lg">
              ...
              <div className="space-y-1 text-sm text-slate-600">
                ...
                <div>â€¢ HELOC for family vacations & education</div>
                <div>â€¢ Down payment assistance programs</div>
                <div>â€¢ Refinancing for better rates</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-blue-200 mt-4">
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ Serving all Anaheim neighborhoods
          </p>
        </div>
      </div>
