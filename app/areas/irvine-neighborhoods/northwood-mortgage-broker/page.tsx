...
export async function generateMetadata() {
  const path = "/areas/irvine-neighborhoods/northwood-mortgage-broker";
  const title = "Mortgage Broker in Northwood, CA | " + SHORT_BRAND;
  const description = "Looking for a trusted mortgage broker in Northwood, Orange County, CA? Compare rates, refinance, or get pre-approved today.";
  return {
    title,
    description,
    ...
    openGraph: {
      title,
      description: "Get expert mortgage help in Northwood, Orange County, CA. Contact us today.",
