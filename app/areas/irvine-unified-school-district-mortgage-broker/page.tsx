...
export async function generateMetadata() {
  ...
  const title = "Mortgage Broker in Irvine Unified School District, CA | " + SHORT_BRAND;
  const description = "Looking for a trusted mortgage broker in Irvine Unified School District, Orange County, CA? Compare rates, refinance, or get pre-approved today.";
  return {
    title,
    description,
    ...
    openGraph: {
      title,
      description: "Get expert mortgage help in Irvine Unified School District, Orange County, CA. Contact us today.",
