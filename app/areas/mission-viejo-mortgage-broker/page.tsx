...
export async function generateMetadata() {
  ...
  const title = "Mortgage Broker in Mission Viejo, CA | " + SHORT_BRAND;
  const description = "Looking for a trusted mortgage broker in Mission Viejo, Orange County, CA? Compare rates, refinance, or get pre-approved today.";
  return {
    title,
    description,
    ...
    openGraph: {
      title,
      description: "Get expert mortgage help in Mission Viejo, Orange County, CA. Contact us today.",
