...
export const metadata: Metadata = {
  ...
  description: 'Newport Beach mortgage broker specializing in luxury home financing. Jumbo loans, conventional mortgages, and investment property financing. Licensed with NEXA Mortgage. Call (949) 579-2057.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-blue-200 mt-4">
            Licensed broker with NEXA Mortgage • NMLS #1426884 • Newport Beach luxury home specialist
          </p>
        </div>
      </div>
    </div>
