...
const NEIGHBORHOOD = "Balboa Island";
const ROUTE = "/areas/newport-beach-neighborhoods/balboa-island-mortgage-broker";
  ...
  return (
    <>
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="text-slate-700">Specializing in jumbo and waterfront home financing with clear guidance.</p>
      </main>
