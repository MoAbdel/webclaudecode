...
const NEIGHBORHOOD = "Newport Coast";
const ROUTE = "/areas/newport-beach-neighborhoods/newport-coast-mortgage-broker";
  ...
  return (
    <>
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="text-slate-700">Specializing in ocean-view and luxury home financing with clear guidance.</p>
      </main>
