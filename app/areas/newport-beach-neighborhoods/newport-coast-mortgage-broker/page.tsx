...
export async function generateMetadata() {
  ...
  const title = "Mortgage Broker in Newport Coast, CA | " + SHORT_BRAND;
  const description = "Looking for a trusted mortgage broker in Newport Coast, Orange County, CA? Compare rates, refinance, or get pre-approved today.";
  return {
    title,
    description,
    ...
    openGraph: {
      title,
      description: "Get expert mortgage help in Newport Coast, Orange County, CA. Contact us today.",
