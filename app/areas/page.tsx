...
export async function generateMetadata() {
  const path = "/areas";
  const title = "Mortgage Broker in Areas, CA | " + SHORT_BRAND;
  const description = "Looking for a trusted mortgage broker in Areas, Orange County, CA? Compare rates, refinance, or get pre-approved today.";
  return {
    title,
    description,
    ...
    openGraph: {
      title,
      description: "Get expert mortgage help in Areas, Orange County, CA. Contact us today.",
