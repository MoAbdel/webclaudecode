...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + '/articles/best-mortgage-broker-orange-county', siteName: 'Mo Abdel – Mortgage Broker', images: ['https://www.mothebroker.com/logo.png'] },
            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <section className="mb-12">
                ...
                <p className="text-xl leading-relaxed text-gray-700">
                  ...
                  Buying a home in Orange County isn't just a major investmentâ€”it's an emotional journey through one of California's most competitive real estate markets. As a dedicated Orange County mortgage professional helping families secure financing across our diverse communities, from coastal Newport Beach to master-planned Irvine, I've learned that your choice of mortgage broker often determines whether your purchase feels empowering or exhausting.
                ...
                <div className="space-y-8">
                  ...
                  <div className="border-l-4 border-blue-600 pl-6">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      A top broker understands nuances between neighborhoodsâ€”why Laguna Beach properties require different loan strategies than Anaheim homes, or how HOA requirements in Irvine's master-planned communities affect lending decisions.
                  ...
                  <div className="border-l-4 border-blue-600 pl-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg mt-4">
                      ...
                      <ul className="grid grid-cols-2 gap-2 text-sm text-gray-700">
                        ...
                        <li>â€¢ National banks</li>

                        <li>â€¢ Local credit unions</li>

                        <li>â€¢ FHA/VA specialists</li>

                        <li>â€¢ Jumbo loan experts</li>

                        <li>â€¢ Self-employed programs</li>

                        <li>â€¢ Foreign national lenders</li>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-8 mb-8">
                  ...
                  <div className="bg-white p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ <strong>0.25% Rate Reduction:</strong> $109/month savings</li>

                      <li>â€¢ <strong>Annual Savings:</strong> $1,308</li>

                      <li>â€¢ <strong>30-Year Total Savings:</strong> $39,240</li>

                      <li>â€¢ <strong>Plus:</strong> Potential lender credits for fees</li>
                ...
                <div className="bg-blue-50 rounded-lg p-8">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ Analyze complete financial picture to maximize buying power</li>

                      <li>â€¢ Identify low down payment programs (FHA, VA, conventional 3%)</li>

                      <li>â€¢ Structure offers with seller credits to reduce closing costs</li>

                      <li>â€¢ Provide detailed pre-approval letters that strengthen offers</li>

                      <li>â€¢ Guide through documentation and timeline requirements</li>
                  ...
                  <div className="bg-white p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ Access to 200+ lenders with varied programs</li>

                      <li>â€¢ Expert guidance through complex processes</li>

                      <li>â€¢ Competitive offer strategies in hot markets</li>

                      <li>â€¢ Clear communication in plain English</li>
                  ...
                  <div className="border-l-4 border-orange-500 pl-6">
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg">
                      ...
                      <ul className="mt-2 space-y-1 text-sm text-gray-700">
                        ...
                        <li>âœ“ Check NMLS Consumer Access website</li>

                        <li>âœ“ Verify active California license</li>

                        <li>âœ“ Review disciplinary history</li>

                        <li>âœ“ Confirm continuing education compliance</li>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ Often require jumbo loans</li>

                      <li>â€¢ Higher insurance requirements</li>

                      <li>â€¢ Potential flood zone considerations</li>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ HOA requirements affect DTI</li>

                      <li>â€¢ Mello-Roos tax considerations</li>

                      <li>â€¢ Great for conventional loans</li>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ More FHA/VA opportunities</li>

                      <li>â€¢ Diverse housing stock</li>

                      <li>â€¢ First-time buyer friendly</li>

                      <li>â€¢ Down payment assistance eligible</li>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ Mix of conforming and jumbo</li>

                      <li>â€¢ Historic property considerations</li>

                      <li>â€¢ Luxury amenity valuations</li>

                      <li>â€¢ Competitive cash buyer market</li>
