...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + '/articles/jumbo-loan-broker-orange-county', siteName: 'Mo Abdel – Mortgage Broker', images: ['https://www.mothebroker.com/logo.png'] },
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ Stricter qualification requirements</li>

                      <li>â€¢ Higher credit score minimums (typically 700+)</li>

                      <li>â€¢ Larger down payment requirements</li>

                      <li>â€¢ More extensive documentation</li>

                      <li>â€¢ Potentially higher interest rates</li>

                      <li>â€¢ Cash reserve requirements</li>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>â€¢ More flexible underwriting guidelines</li>

                      <li>â€¢ Customized loan structures</li>

                      <li>â€¢ Competitive rates for strong borrowers</li>

                      <li>â€¢ Portfolio lender flexibility</li>

                      <li>â€¢ Jumbo ARM products with lower initial rates</li>

                      <li>â€¢ Interest-only payment options</li>
                  ...
                  <div className="border-l-4 border-purple-600 pl-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <ul className="text-sm text-gray-700 space-y-1">
                        ...
                        <li>â€¢ Include all income sources (salary, bonuses, investments)</li>

                        <li>â€¢ Two-year average for variable income</li>

                        <li>â€¢ Consider tax benefits of mortgage interest deduction</li>

                        <li>â€¢ Account for HOA dues and property taxes in calculations</li>
                    ...
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        ...
                        <ul className="space-y-1 text-gray-700">
                          ...
                          <li>âœ“ Money market accounts</li>

                          <li>âœ“ Stocks and bonds (70% of value)</li>

                          <li>âœ“ Mutual funds</li>

                        </ul>

                        <ul className="space-y-1 text-gray-700">

                          <li>âœ“ 401(k)/IRA (60% of vested balance)</li>

                          <li>âœ“ CDs and treasury bills</li>

                          <li>âœ— Real estate equity</li>

                          <li>âœ— Business assets</li>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="bg-green-100 text-green-800 p-1 rounded-full">âœ“</span>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="bg-purple-100 text-purple-800 p-1 rounded-full">â˜…</span>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700 text-sm">
                      ...
                      <li>â€¢ Median prices: $2M-$5M+</li>

                      <li>â€¢ Multiple appraisals often required</li>

                      <li>â€¢ Higher insurance requirements</li>

                      <li>â€¢ Strong appreciation history</li>

                      <li>â€¢ Cash competition common</li>

                      <li>â€¢ Flood zone considerations</li>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700 text-sm">
                      ...
                      <li>â€¢ Median prices: $1.2M-$3M</li>

                      <li>â€¢ Master-planned communities</li>

                      <li>â€¢ HOA and Mello-Roos considerations</li>

                      <li>â€¢ Excellent school districts</li>

                      <li>â€¢ More conventional jumbo options</li>

                      <li>â€¢ Golf course/gated communities</li>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700 text-sm">
                      ...
                      <li>â€¢ Median prices: $1M-$2.5M</li>

                      <li>â€¢ Historic property considerations</li>

                      <li>â€¢ Unique architectural features</li>

                      <li>â€¢ Special appraisal requirements</li>

                      <li>â€¢ Renovation loan options</li>

                      <li>â€¢ Character property expertise needed</li>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-700 text-sm">
                      ...
                      <li>â€¢ Median prices: $1.1M-$2M</li>

                      <li>â€¢ Newer luxury developments</li>

                      <li>â€¢ Growing appreciation potential</li>

                      <li>â€¢ More affordable luxury options</li>

                      <li>â€¢ Good jumbo loan availability</li>

                      <li>â€¢ Family-oriented communities</li>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          ...
                          <li>â€¢ Build 12+ months reserves</li>

                          <li>â€¢ Pay down high-interest debt</li>

                          <li>â€¢ Avoid major purchases or credit inquiries</li>

                          <li>â€¢ Document all income sources</li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          ...
                          <li>â€¢ Organize 2+ years tax returns</li>

                          <li>â€¢ Prepare asset statements</li>

                          <li>â€¢ Get CPA-prepared P&L if self-employed</li>

                          <li>â€¢ Document gift funds properly</li>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          ...
                          <li>â€¢ Include rental income (75% of gross)</li>

                          <li>â€¢ Document investment income</li>

                          <li>â€¢ Use asset depletion for qualification</li>

                          <li>â€¢ Consider co-borrower addition</li>
                      ...
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-1">
                          ...
                          <li>â€¢ Consider ARM vs. fixed based on timeline</li>

                          <li>â€¢ Evaluate interest-only options</li>

                          <li>â€¢ Compare single loan vs. piggyback</li>

                          <li>â€¢ Assess points vs. higher rate</li>
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Jumbo Loan Broker Orange County | Mo Abdel","mainEntityOfPage":"https://www.mothebroker.com/articles/jumbo-loan-broker-orange-county","author":{"@type":"Person","name":"Mo Abdel"},"publisher":{"@type":"Organization","name":"Mo Abdel â€” Mortgage Broker","logo":{"@type":"ImageObject","url":"https://www.mothebroker.com/logo.png"}},"image":"https://www.mothebroker.com/logo.png"})
}} />
</>
