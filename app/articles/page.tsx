...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + '/articles', siteName: 'Mo Abdel – Mortgage Broker', images: ['https://www.mothebroker.com/logo.png'] },
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Articles | Mo Abdel","mainEntityOfPage":"https://www.mothebroker.com/articles","author":{"@type":"Person","name":"Mo Abdel"},"publisher":{"@type":"Organization","name":"Mo Abdel â€” Mortgage Broker","logo":{"@type":"ImageObject","url":"https://www.mothebroker.com/logo.png"}},"image":"https://www.mothebroker.com/logo.png"})
}} />
</>
