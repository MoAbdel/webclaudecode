...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/fha-loans-orange-county" },
    openGraph: { title, description, url: BASE + "/fha-loans-orange-county", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
