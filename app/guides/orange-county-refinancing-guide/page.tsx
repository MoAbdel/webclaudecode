...
export const metadata: Metadata = {
  ...
  description: 'Complete Orange County refinancing guide covering rate-and-term refinancing, Cash-Out Refi, HELOC, and HELOAN options. Expert mortgage broker insights for homeowners.',
  ...
  openGraph: {
    ...
    description: 'Complete Orange County refinancing guide covering rate-and-term refinancing, Cash-Out Refi, HELOC, and HELOAN options.',
    type: 'article',
