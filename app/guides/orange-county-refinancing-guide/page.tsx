...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/guides/orange-county-refinancing-guide" },
    openGraph: { title, description, url: BASE + "/guides/orange-county-refinancing-guide", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
...
const faqs = [
...

  {
    ...
    answer: 'Refinancing rates vary daily based on market conditions, loan type, and borrower qualifications. Rate-and-term refinances typically offer the best rates, while Cash-Out Refis are slightly higher. HELOC rates are variable and tied to prime rate, while HELOAN rates are fixed. Contact Mo Abdel at (949) 579-2057 for current rates and personalized quotes.'
...

  {
    ...
    answer: 'Rate-and-term refinances typically take 2-3 weeks, while Cash-Out Refis may take 2-3 weeks due to additional documentation requirements. HELOCs and HELOANs usually close in 2-3 weeks. Factors affecting timeline include appraisal scheduling, document submission speed, and lender processing times.'
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Orange County Refinancing Guide | Mo Abdel","mainEntityOfPage":"https://www.mothebroker.com/guides/orange-county-refinancing-guide","author":{"@type":"Person","name":"Mo Abdel"},"publisher":{"@type":"Organization","name":"Mo Abdel â€” Mortgage Broker","logo":{"@type":"ImageObject","url":"https://www.mothebroker.com/logo.png"}},"image":"https://www.mothebroker.com/logo.png"})
}} />
</div>
