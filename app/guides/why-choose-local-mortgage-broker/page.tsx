...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/guides/why-choose-local-mortgage-broker" },
    openGraph: { title, description, url: BASE + "/guides/why-choose-local-mortgage-broker", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center justify-center text-sm text-slate-500 mb-4">
            ...
            <span>Published July 18, 2025 â€¢ By Mo Abdel, Orange County Mortgage Broker</span>
          ...
          <div className="flex items-center text-sm text-slate-500">
            ...
            5 min read â€¢ Updated July 18, 2025 â€¢ NMLS #1426884
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Why Choose Local Mortgage Broker | Mo Abdel","mainEntityOfPage":"https://www.mothebroker.com/guides/why-choose-local-mortgage-broker","author":{"@type":"Person","name":"Mo Abdel"},"publisher":{"@type":"Organization","name":"Mo Abdel â€” Mortgage Broker","logo":{"@type":"ImageObject","url":"https://www.mothebroker.com/logo.png"}},"image":"https://www.mothebroker.com/logo.png"})
}} />
</div>
