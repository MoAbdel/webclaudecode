...
export const metadata: Metadata = {
  ...
  description: 'Get a HELOC with competitive rates. Mo Abdel helps homeowners in Orange County access equity for projects or debt consolidation.',
  keywords: 'HELOC Orange County, HELOC California, Orange County home equity loans, competitive HELOC rates'
};
