...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon.ico?v=7', sizes: '48x48 32x32 16x16', type: 'image/x-icon' },
      { url: '/favicon-32x32.png?v=7', sizes: '32x32', type: 'image/png' },
      { url: '/favicon-16x16.png?v=7', sizes: '16x16', type: 'image/png' },
      { url: '/favicon-64x64.png?v=7', sizes: '64x64', type: 'image/png' },
      { url: '/favicon-128x128.png?v=7', sizes: '128x128', type: 'image/png' },
      { url: '/favicon-192x192.png?v=7', sizes: '192x192', type: 'image/png' },
      { url: '/favicon-512x512.png?v=7', sizes: '512x512', type: 'image/png' },
      { url: '/android-chrome-192x192.png?v=7', sizes: '192x192', type: 'image/png' },
      { url: '/android-chrome-512x512.png?v=7', sizes: '512x512', type: 'image/png' },
    ],
    shortcut: '/favicon.ico?v=7',
    apple: [
      { url: '/apple-touch-icon-180x180.png?v=7', sizes: '180x180', type: 'image/png' },
    ],
  },
  openGraph: {
    title: 'Orange County Mortgage Broker | Mo Abdel NMLS #1426884',
