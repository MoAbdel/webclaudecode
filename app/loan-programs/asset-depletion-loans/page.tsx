...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/asset-depletion-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/asset-depletion-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-green-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ Retirees with substantial assets</li>

                <li>â€¢ High net worth individuals</li>

                <li>â€¢ Business owners with asset-heavy portfolios</li>

                <li>â€¢ Investors with multiple income streams</li>

                <li>â€¢ Trust fund beneficiaries</li>

                <li>â€¢ Foreign nationals with US assets</li>

                <li>â€¢ Those between jobs but asset-rich</li>
        ...
        <div className="bg-slate-100 rounded-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">âœ… Qualifying Assets (100%)</h3>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4 mt-6">âœ… Retirement Accounts (70%)</h3>
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">âŒ Non-Qualifying Assets</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-slate-700">
                    ...
                    <div>â€¢ Tech executives with substantial stock options</div>

                    <div>â€¢ Retirees downsizing from larger homes</div>

                    <div>â€¢ Business owners with asset-heavy portfolios</div>

                    <div>â€¢ Foreign investors with US investment accounts</div>
        ...
        <div className="bg-green-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-green-100 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ High Net Worth Specialist
