...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/loan-programs/cash-out-refinance", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center bg-orange-100 text-orange-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            ðŸ”¥ Most Popular Refinance Option
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  Major Home Improvements</h3>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸš¨ Large Emergency Fund</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-green-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold text-green-800 mb-4">âœ… Great Time for Cash-Out Refi</h3>
            ...
            <div className="bg-red-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold text-red-800 mb-4">âš ï¸ Consider Other Options When</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600 space-y-1">
                ...
                <div>â€¢ Credit score: 620+ (640+ for best rates)</div>

                <div>â€¢ Debt-to-income: â‰¤45%</div>

                <div>â€¢ 2+ years employment history</div>

                <div>â€¢ Income documentation required</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600 space-y-1">
                ...
                <div>â€¢ 20%+ equity required</div>

                <div>â€¢ Max 80% combined LTV</div>

                <div>â€¢ Property appraisal required</div>

                <div>â€¢ Primary, second home, or investment</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600 space-y-1">
                ...
                <div>â€¢ Closing costs: 2-3% of loan amount</div>

                <div>â€¢ Can be financed into loan</div>

                <div>â€¢ 2-3 week process</div>

                <div>â€¢ Cash at closing</div>
        ...
        <section className="mt-16">
          ...
          <div className="space-y-4 text-slate-700">
            <details><summary className="font-semibold">How much cash can I take out?</summary><p>It depends on your home value, program, and credit. Weâ€™ll calculate a safe maximum for you.</p></details>
            <details><summary className="font-semibold">Will my interest rate change?</summary><p>Often you can get cash and a competitive rate. Weâ€™ll compare total cost vs. HELOC/HELOAN.</p></details>
        ...
        {(() => {
          ...
          const faqSchema = {
            ...
            "@type": "FAQPage",
            "mainEntity": [
              {"@type":"Question","name":"How much cash can I take out?","acceptedAnswer":{"@type":"Answer","text":"Based on value, program, and credit; weâ€™ll calculate your safe max."}},
              {"@type":"Question","name":"Will my interest rate change?","acceptedAnswer":{"@type":"Answer","text":"Often you can get cash and a competitive rate; weâ€™ll compare options."}},
