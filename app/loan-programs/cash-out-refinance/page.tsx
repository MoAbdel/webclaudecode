...
export const metadata: Metadata = {
  title: 'Cash-Out Refi in Orange County, CA | Replace Mortgage + Get Cash | Mo Abdel — Mortgage Broker',
  description: 'Cash-Out Refi in Orange County, CA. Replace your mortgage and get cash. Get rates or call (949) 579-2057.',
