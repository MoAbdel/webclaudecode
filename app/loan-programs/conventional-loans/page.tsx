...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/conventional-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/conventional-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ† Best Rates Available</h3>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ›¡ï¸ PMI Can Be Removed</h3>
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  Any Property Type</h3>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’° Higher Loan Amounts</h3>
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">âš¡ Faster Processing</h3>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ“ˆ Cash-Out Friendly</h3>

                <p className="text-slate-600 mb-3">Higher Cash-Out Refi limits (up to 80% LTV) and more flexible uses of proceeds than government programs.</p>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">âœ… Qualifying Standards</h3>
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">ðŸ“‹ Additional Considerations</h3>
        ...
        <section className="mt-16">
          ...
          <div className="space-y-4 text-slate-700">
            ...
            <details>
              ...
              <p>Conventional loans can go as low as 3% down for well-qualified buyers. Weâ€™ll help you choose the best option for your budget and goals.</p>
            </details>
            <details>
          ...
          const faqSchema = {
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": { "@type": "Answer", "text": "As low as 3% down for qualified buyers; weâ€™ll help you compare." }
              },
              {
                "@type": "Question",
