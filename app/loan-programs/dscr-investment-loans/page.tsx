...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/dscr-investment-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/dscr-investment-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div className="text-center">
              ...
              <ul className="text-left space-y-2 text-slate-700">
                ...
                <li>â€¢ No income documentation required</li>

                <li>â€¢ No employment verification</li>

                <li>â€¢ Qualify based on rental income</li>

                <li>â€¢ Up to $2M loan amounts</li>

                <li>â€¢ Purchase or refinance</li>

                <li>â€¢ Portfolio lending available</li>
            ...
            <div className="text-center">
              ...
              <ul className="text-left space-y-2 text-slate-700">
                ...
                <li>â€¢ 1.0+ DSCR ratio minimum</li>

                <li>â€¢ 20-25% down payment</li>

                <li>â€¢ 620+ credit score</li>

                <li>â€¢ 2-6 months reserves</li>

                <li>â€¢ Investment property experience preferred</li>

                <li>â€¢ Property appraisal and rent roll</li>
            ...
            <div className="text-center">
              ...
              <ul className="text-left space-y-2 text-slate-700">
                ...
                <li>â€¢ Self-employed borrowers</li>

                <li>â€¢ Retirees with rental income</li>

                <li>â€¢ Foreign national investors</li>

                <li>â€¢ Portfolio property owners</li>

                <li>â€¢ 1031 exchange buyers</li>
        ...
        <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-blue-100 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ Investment Specialist
