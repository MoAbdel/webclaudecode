...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/fix-flip-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/fix-flip-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ Experienced real estate investors</li>

                <li>â€¢ House flippers and rehabbers</li>

                <li>â€¢ Real estate wholesalers</li>

                <li>â€¢ Construction and development pros</li>

                <li>â€¢ Property management companies</li>

                <li>â€¢ Real estate syndicators</li>

                <li>â€¢ Fix and hold investors (bridge to perm)</li>
        ...
        <div className="bg-purple-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-purple-100 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ Investor Specialist
