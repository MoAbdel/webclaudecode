...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/heloan" },
    openGraph: { title, description, url: BASE + "/loan-programs/heloan", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16 bg-green-50 p-6 rounded-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-slate-700">HELOAN rates are fixed for the selected term. Weâ€™ll compare current options and outline how points, lender credits, or term choices could affect your APR and total cost.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Closing Costs</h3>
              <p className="text-slate-700">Closing costs vary by lender and program. Weâ€™ll provide a transparent estimate of fees before you proceed.</p>
            </div>
          </div>
        </section>
            ...
            <table className="w-full bg-white rounded-lg shadow-lg">
              ...
              <tbody className="divide-y divide-slate-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-center text-orange-500">âš ï¸ Variable</td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  Major Home Renovations</h3>
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ˜ï¸ Investment Property Down Payment</h3>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸš— Major Purchases</h3>
        ...
        <section className="mt-16">
          ...
          <div className="space-y-4 text-slate-700">
            ...
            <details><summary className="font-semibold">What loan sizes are common?</summary><p>Many borrowers use $50Kâ€“$500K, depending on equity, credit, and lender guidelines.</p></details>
          </div>
        </section>
        ...
        {(() => {
          ...
          const faqSchema = {
            ...
            "mainEntity":[
              ...
              {"@type":"Question","name":"What loan sizes are common?","acceptedAnswer":{"@type":"Answer","text":"Many borrowers use $50Kâ€“$500K, depending on equity, credit, and lender guidelines."}}
            ]
          };
          return (<>
