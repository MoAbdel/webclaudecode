...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/heloc" },
    openGraph: { title, description, url: BASE + "/loan-programs/heloc", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            ðŸ”¥ #1 Most Popular Program in Orange County
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            ...
            <p className="text-slate-600">HELOC rates may be variable or fixed depending on the program. Weâ€™ll compare current options and outline how rate adjustments, caps, or fixed-rate features (if available) could affect your payment.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            ...
            <p className="text-slate-600">Closing costs vary by lender and program. Weâ€™ll provide a transparent estimate of fees before you proceed.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  Home Renovations</h3>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’³ Debt Consolidation</h3>
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ˜ï¸ Real Estate Investment</h3>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸŽ“ Education Expenses</h3>
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸš¨ Emergency Fund</h3>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’¼ Business Investment</h3>
        ...
        <section className="mt-16">
          ...
          <div className="space-y-4 text-slate-700">
            <details><summary className="font-semibold">Are HELOC rates variable?</summary><p>Many HELOCs are variable; some programs may offer fixed-rate features. Weâ€™ll review current options and caps.</p></details>
            <details><summary className="font-semibold">How much can I draw?</summary><p>Typical ranges depend on equity, credit, and lender guidelines. Weâ€™ll calculate a safe maximum for your scenario.</p></details>
            <details><summary className="font-semibold">How does repayment work?</summary><p>Draw periods allow access to funds, followed by a repayment period. Weâ€™ll outline examples based on your terms.</p></details>
          </div>
        </section>
        ...
        {(() => {
          ...
          const faqSchema = {
            ...
            "@type":"FAQPage",
            "mainEntity":[
              {"@type":"Question","name":"Are HELOC rates variable?","acceptedAnswer":{"@type":"Answer","text":"Many HELOCs are variable; some programs may offer fixed-rate features. Weâ€™ll review current options and caps."}},
              {"@type":"Question","name":"How much can I draw?","acceptedAnswer":{"@type":"Answer","text":"Typical ranges depend on equity, credit, and lender guidelines. Weâ€™ll calculate a safe maximum for your scenario."}},
              {"@type":"Question","name":"How does repayment work?","acceptedAnswer":{"@type":"Answer","text":"Draw periods allow access to funds, followed by a repayment period. Weâ€™ll outline examples based on your terms."}}
            ]
          };
          return (<>
        ...
        <div className="bg-slate-100 rounded-lg p-4 mt-8">
          <p className="text-xs text-slate-600">
            Program availability, terms, and costs are subject to change and eligibility. Weâ€™ll present written loan estimates for comparison.
          </p>
        </div>
