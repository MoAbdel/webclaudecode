...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/loan-programs/jumbo-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ° No Loan Amount Restrictions</h3>
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’Ž Premium Service & Expertise</h3>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ›¡ï¸ No Mortgage Insurance</h3>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  All Property Types Welcome</h3>
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">âš¡ Competitive Interest Rates</h3>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ“ˆ Portfolio & Investment Benefits</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">âœ… Enhanced Qualifying Standards</h3>
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">âš ï¸ Important Considerations</h3>
            ...
            <div className="bg-purple-50 p-8 rounded-2xl">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm text-slate-600">
                  ...
                  <div>â€¢ Laguna Beach</div>

                  <div>â€¢ Irvine</div>

                  <div>â€¢ Dana Point</div>

                  <div>â€¢ Manhattan Beach</div>

                  <div>â€¢ San Clemente</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  Standard Jumbo</h3>

                <div className="space-y-2 text-sm text-slate-600">

                  <div>â€¢ 10-20% down payment</div>

                  <div>â€¢ 700+ credit score</div>

                  <div>â€¢ Primary & second homes</div>

                  <div>â€¢ Full documentation</div>

                  <div>â€¢ Best rates available</div>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’¼ Investment Jumbo</h3>

                <div className="space-y-2 text-sm text-slate-600">

                  <div>â€¢ 25-30% down payment</div>

                  <div>â€¢ 720+ credit score</div>

                  <div>â€¢ 6+ months reserves</div>

                  <div>â€¢ Rental income considered</div>

                  <div>â€¢ Multiple properties OK</div>
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸŒ Foreign National</h3>

                <div className="space-y-2 text-sm text-slate-600">

                  <div>â€¢ 30-40% down payment</div>

                  <div>â€¢ No US credit history needed</div>

                  <div>â€¢ International income OK</div>

                  <div>â€¢ Asset-based programs</div>

                  <div>â€¢ Specialized underwriting</div>
        ...
        <section className="mt-16">
          ...
          <div className="space-y-4 text-slate-700">
            <details><summary className="font-semibold">Whatâ€™s considered a Jumbo loan in OC?</summary><p>Loans above $1,209,750 (2025) for a 1-unit home are Jumbo in Orange County, CA.</p></details>
            <details><summary className="font-semibold">Are jumbo rates higher?</summary><p>Not always; competitive profiles can be near conforming rates. Weâ€™ll shop aggressively.</p></details>
            <details><summary className="font-semibold">Do I need reserves?</summary><p>Many investors require 2â€“6 months of reserves. Weâ€™ll outline program-specific requirements.</p></details>
          </div>
        </section>
        ...
        {(() => {
          ...
          const faqSchema = {
            ...
            "@type":"FAQPage",
            "mainEntity":[
              {"@type":"Question","name":"Whatâ€™s considered a Jumbo loan in OC?","acceptedAnswer":{"@type":"Answer","text":"Above $1,209,750 (1-unit) in Orange County, CA for 2025."}},
              {"@type":"Question","name":"Are jumbo rates higher?","acceptedAnswer":{"@type":"Answer","text":"Depends on profile; weâ€™ll shop multiple investors for best terms."}},
              {"@type":"Question","name":"Do I need reserves?","acceptedAnswer":{"@type":"Answer","text":"Often 2â€“6 months PITI depending on program and property type."}}
            ]
          };
          return (<>
        ...
        <div className="text-center bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-purple-200 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ Luxury home financing specialist
