...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/non-qm-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/non-qm-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <Link href="/loan-programs/bank-statement-loans" className="block">
              ...
              <Card className="border-l-4 border-l-blue-500 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ¦ Bank Statement Loans</h3>

                  <div className="space-y-2 text-sm text-slate-600 mb-4">

                    <div>â€¢ 12-24 months bank statements</div>

                    <div>â€¢ No tax returns required</div>

                    <div>â€¢ Personal & business accounts</div>

                    <div>â€¢ Cash flow analysis</div>
            ...
            <Link href="/loan-programs/asset-depletion-loans" className="block">
              ...
              <Card className="border-l-4 border-l-green-500 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’° Asset-Based Loans</h3>

                  <div className="space-y-2 text-sm text-slate-600 mb-4">

                    <div>â€¢ Income based on liquid assets</div>

                    <div>â€¢ Stocks, bonds, retirement accounts</div>

                    <div>â€¢ Asset depletion calculation</div>

                    <div>â€¢ No employment verification</div>

                    <div>â€¢ 20-30% down payment</div>
            ...
            <Link href="/loan-programs/profit-loss-statement-loans" className="block">
              ...
              <Card className="border-l-4 border-l-purple-500 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ“Š P&L Statement Loans</h3>

                  <div className="space-y-2 text-sm text-slate-600 mb-4">

                    <div>â€¢ CPA-prepared P&L statements</div>

                    <div>â€¢ Business financial statements</div>

                    <div>â€¢ No personal tax returns</div>

                    <div>â€¢ Business income qualification</div>

                    <div>â€¢ 10-25% down payment</div>
            ...
            <Link href="/loan-programs/dscr-investment-loans" className="block">
              ...
              <Card className="border-l-4 border-l-orange-500 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  DSCR Loans</h3>

                  <div className="space-y-2 text-sm text-slate-600 mb-4">

                    <div>â€¢ Debt Service Coverage Ratio</div>

                    <div>â€¢ Property cash flow based</div>

                    <div>â€¢ No personal income verification</div>

                    <div>â€¢ Investment properties only</div>

                    <div>â€¢ 20-25% down payment</div>
              ...
              <Card className="border-l-4 border-l-yellow-500 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 text-sm text-slate-600 mb-4">
                    ...
                    <div>â€¢ No US credit required</div>

                    <div>â€¢ Foreign income acceptable</div>

                    <div>â€¢ ITIN or passport acceptable</div>

                    <div>â€¢ International asset verification</div>
            ...
            <Link href="/loan-programs/fix-flip-loans" className="block">
              ...
              <Card className="border-l-4 border-l-purple-600 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ—ï¸ Fix & Flip Loans</h3>

                  <div className="space-y-2 text-sm text-slate-600 mb-4">

                    <div>â€¢ Short-term financing (6-24 months)</div>

                    <div>â€¢ Quick closing (7-10 days)</div>

                    <div>â€¢ Up to 90% of purchase price</div>

                    <div>â€¢ Interest-only payments</div>

                    <div>â€¢ Rehab funds available</div>
            ...
            <Link href="/loan-programs/usda-rural-loans" className="block">
              ...
              <Card className="border-l-4 border-l-green-600 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full cursor-pointer">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸŒ¾ USDA Rural Loans</h3>

                  <div className="space-y-2 text-sm text-slate-600 mb-4">

                    <div>â€¢ 0% down payment required</div>

                    <div>â€¢ No PMI required</div>

                    <div>â€¢ Income limits apply</div>

                    <div>â€¢ Rural area requirement</div>

                    <div>â€¢ Primary residence only</div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-orange-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold text-orange-800 mb-4">âœ… Perfect Candidates</h3>
            ...
            <div className="bg-slate-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-4">ðŸ’¡ Common Situations</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">âœ… General Requirements</h3>
            ...
            <div className="bg-orange-50 p-8 rounded-2xl">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-2 text-sm text-slate-600">
                  ...
                  <div>â€¢ Real Estate Agents/Brokers</div>

                  <div>â€¢ Business Owners/Entrepreneurs</div>

                  <div>â€¢ Independent Contractors</div>

                  <div>â€¢ Investment Property Owners</div>

                  <div>â€¢ Commission Sales Professionals</div>

                  <div>â€¢ Foreign Nationals</div>
        ...
        <div className="text-center bg-gradient-to-r from-orange-600 to-orange-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-orange-200 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ Non-QM lending specialist
