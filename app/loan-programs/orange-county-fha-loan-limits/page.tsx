...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/orange-county-fha-loan-limits" },
    openGraph: { title, description, url: BASE + "/loan-programs/orange-county-fha-loan-limits", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-green-50 p-8 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3">ðŸ  High Coverage Cities</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3">ðŸ˜ï¸ Moderate Coverage Cities</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-3">ðŸ–ï¸ Premium Coastal Cities</h3>
        ...
        <div className="text-center bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-green-200 mt-4">
            ...
            Licensed FHA specialist â€¢ NMLS #1426884 â€¢ Orange County mortgage broker since 2015
