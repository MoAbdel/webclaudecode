...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/orange-county-va-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/orange-county-va-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            ðŸ‡ºðŸ‡¸ Serving Those Who Served
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸ˜ï¸ Irvine</h3>

                <p className="text-slate-600 mb-3">Family-friendly with excellent schools and amenities</p>

                <div className="text-sm text-slate-500 space-y-1">

                  <div>â€¢ Median Price: $1.4M</div>

                  <div>â€¢ Top-rated schools</div>

                  <div>â€¢ Master-planned communities</div>

                  <div>â€¢ 75% under VA loan limit</div>
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸ  Westminster</h3>

                <p className="text-slate-600 mb-3">Affordable family homes with good value</p>

                <div className="text-sm text-slate-500 space-y-1">

                  <div>â€¢ Median Price: $800K</div>

                  <div>â€¢ 95% under VA loan limit</div>

                  <div>â€¢ Close to military bases</div>

                  <div>â€¢ Strong appreciation</div>
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸŒŠ Huntington Beach</h3>

                <p className="text-slate-600 mb-3">Beach lifestyle with diverse housing options</p>

                <div className="text-sm text-slate-500 space-y-1">

                  <div>â€¢ Median Price: $1.1M</div>

                  <div>â€¢ Beach community</div>

                  <div>â€¢ 60% under VA loan limit</div>

                  <div>â€¢ Military-friendly area</div>
            ...
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-2 text-sm text-slate-600">
                  ...
                  <div>â€¢ Westminster (close to Los Alamitos)</div>

                  <div>â€¢ Garden Grove (military families)</div>

                  <div>â€¢ Irvine (veteran community)</div>

                  <div>â€¢ Huntington Beach (coastal access)</div>
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-blue-200 mt-4">
            ...
            Licensed VA loan specialist â€¢ NMLS #1426884 â€¢ Proudly serving Orange County veterans and military
