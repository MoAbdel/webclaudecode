...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/loan-programs/profit-loss-statement-loans", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
