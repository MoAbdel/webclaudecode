...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/profit-loss-statement-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/profit-loss-statement-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center bg-purple-100 text-purple-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            ðŸ“Š CPA-Prepared Documentation
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-purple-50 p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold text-purple-800 mb-4">âœ… Perfect Candidates</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">âœ… Qualification Criteria</h3>
            ...
            <div className="bg-purple-50 p-8 rounded-2xl">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-2 text-sm text-slate-600">
                  ...
                  <div>â€¢ Medical Practice Owners</div>

                  <div>â€¢ Law Firm Partners</div>

                  <div>â€¢ CPA Firm Owners</div>

                  <div>â€¢ Consulting Business Owners</div>

                  <div>â€¢ Franchise Owners</div>

                  <div>â€¢ Real Estate Brokers</div>
        ...
        <div className="text-center bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-purple-200 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ P&L Statement loan specialist
