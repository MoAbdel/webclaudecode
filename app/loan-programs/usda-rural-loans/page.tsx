...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/loan-programs/usda-rural-loans" },
    openGraph: { title, description, url: BASE + "/loan-programs/usda-rural-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <ul className="text-left space-y-2 text-slate-700">
                ...
                <li>â€¢ Flexible credit guidelines</li>

                <li>â€¢ Can finance closing costs</li>

                <li>â€¢ Government-backed program</li>
            ...
            <div className="text-center">
              ...
              <ul className="text-left space-y-2 text-slate-700">
                ...
                <li>â€¢ Property in USDA eligible area</li>

                <li>â€¢ Primary residence only</li>

                <li>â€¢ Income limits apply by area</li>

                <li>â€¢ US citizenship required</li>

                <li>â€¢ 640+ credit score preferred</li>
            ...
            <div className="text-center">
              ...
              <ul className="text-left space-y-2 text-slate-700">
                ...
                <li>â€¢ Limited eligible areas</li>

                <li>â€¢ Mainly outer suburban zones</li>

                <li>â€¢ Check USDA eligibility map</li>

                <li>â€¢ Income limits vary by household</li>

                <li>â€¢ Property type restrictions apply</li>

                <li>â€¢ Must meet rural definition</li>
        ...
        <div className="bg-yellow-600 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-yellow-100 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ USDA Approved Lender
