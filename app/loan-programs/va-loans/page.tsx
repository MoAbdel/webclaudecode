...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/loan-programs/va-loans", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center bg-red-100 text-red-800 px-4 py-2 rounded-full text-sm font-semibold mb-4">
            ...
            ðŸ‡ºðŸ‡¸ Exclusive Military Benefits
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-l-4 border-l-red-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ’° $0 Down Payment</h3>
            ...
            <Card className="border-l-4 border-l-blue-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ›¡ï¸ No Private Mortgage Insurance</h3>
            ...
            <Card className="border-l-4 border-l-green-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ“Š Flexible Underwriting</h3>
            ...
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ”„ Reusable Entitlement</h3>
            ...
            <Card className="border-l-4 border-l-orange-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">ðŸ  No Prepayment Penalties</h3>
            ...
            <Card className="border-l-4 border-l-yellow-500">
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">âš¡ VA IRRRL Refinancing</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">âœ… Eligible Service Members</h3>
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-6">ðŸ“‹ Additional Requirements</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸ–ï¸ Huntington Beach</h3>

                <p className="text-slate-600 mb-2">Close to military bases, beach lifestyle, family-friendly</p>

                <div className="text-sm text-slate-500">

                  â€¢ 15 min to Joint Forces Training Base

                  â€¢ Excellent schools and recreation
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸŒŠ Costa Mesa</h3>

                <p className="text-slate-600 mb-2">Central location, diverse housing options</p>

                <div className="text-sm text-slate-500">

                  â€¢ Easy freeway access
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸ¡ Garden Grove</h3>

                <p className="text-slate-600 mb-2">Affordable options, diverse community</p>

                <div className="text-sm text-slate-500">

                  â€¢ Military-friendly pricing
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸŽ¯ Mission Viejo</h3>

                <p className="text-slate-600 mb-2">Family-oriented, excellent schools</p>

                <div className="text-sm text-slate-500">

                  â€¢ Master-planned community
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸŒ… San Clemente</h3>

                <p className="text-slate-600 mb-2">Beach town, close to Camp Pendleton</p>

                <div className="text-sm text-slate-500">

                  â€¢ 30 min to Camp Pendleton
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">ðŸ  Orange</h3>

                <p className="text-slate-600 mb-2">Historic charm, family neighborhoods</p>

                <div className="text-sm text-slate-500">

                  â€¢ Classic neighborhoods

                  â€¢ Good value options
        ...
        <section className="mt-16">
          ...
          <div className="space-y-4 text-slate-700">
            ...
            <details><summary className="font-semibold">Is there a funding fee?</summary><p>VA loans include a funding fee; weâ€™ll explain exemptions and exact amounts for you.</p></details>
            <details><summary className="font-semibold">Can I buy a condo?</summary><p>Yes, subject to VA condo approval. Weâ€™ll check eligibility in your target area.</p></details>
          </div>
        </section>
        ...
        {(() => {
          ...
          const faqSchema = {
            ...
            "mainEntity":[
              ...
              {"@type":"Question","name":"Is there a funding fee?","acceptedAnswer":{"@type":"Answer","text":"Yes; weâ€™ll explain exemptions and exact amounts for your situation."}},
        ...
        <div className="text-center bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-red-200 mt-4">
            ...
            Licensed mortgage broker with NEXA Mortgage â€¢ NMLS #1426884 â€¢ Proudly serving our veterans and military families
