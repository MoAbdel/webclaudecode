...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/luxury-markets/golf-course-homes-mortgage-broker" },
    openGraph: { title, description, url: BASE + "/luxury-markets/golf-course-homes-mortgage-broker", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
