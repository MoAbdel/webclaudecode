...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/neighborhood-guide/irvine-vs-newport-beach-home-buying-guide", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center text-sm text-slate-500 mb-4">
            ...
            <span>Published March 15, 2025 â€¢ By Mo Abdel, Orange County Mortgage Broker</span>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold mb-3 text-green-600">âœ… Why Choose Irvine</h3>

                <ul className="space-y-2 text-slate-700">

                  <li>â€¢ <strong>Top-rated schools:</strong> Irvine Unified School District consistently ranks #1 in California</li>

                  <li>â€¢ <strong>Master-planned communities:</strong> Newer construction, well-designed neighborhoods</li>

                  <li>â€¢ <strong>Family-friendly:</strong> Parks, playgrounds, and community centers throughout</li>

                  <li>â€¢ <strong>Safety:</strong> Consistently ranked safest city in America</li>

                  <li>â€¢ <strong>Tech hub proximity:</strong> Close to major employers like Broadcom, Blizzard Entertainment</li>

                  <li>â€¢ <strong>Better value:</strong> More home for your money compared to coastal areas</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-700">
                  ...
                  <li>â€¢ Limited nightlife and entertainment options</li>

                  <li>â€¢ Can feel "corporate" or sterile to some</li>

                  <li>â€¢ No beach access (15-20 min drive to coast)</li>

                  <li>â€¢ Heavy traffic on major roads during rush hour</li>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-700">
                  ...
                  <li>â€¢ <strong>Oceanfront lifestyle:</strong> Beach access, boating, water activities</li>

                  <li>â€¢ <strong>Luxury amenities:</strong> High-end shopping, dining, entertainment</li>

                  <li>â€¢ <strong>Investment potential:</strong> Strong appreciation history, desirable location</li>

                  <li>â€¢ <strong>Prestige factor:</strong> Recognized luxury address worldwide</li>

                  <li>â€¢ <strong>Climate:</strong> Ocean breezes, mild temperatures year-round</li>

                  <li>â€¢ <strong>Quality schools:</strong> Newport Mesa and Corona del Mar areas</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-700">
                  ...
                  <li>â€¢ Significantly higher home prices and living costs</li>

                  <li>â€¢ Limited inventory, competitive market</li>

                  <li>â€¢ Parking challenges in dense areas</li>

                  <li>â€¢ Tourist crowds during summer months</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>â€¢ <strong>Loan Amount:</strong> $1.4M average (often jumbo loans)</li>

                <li>â€¢ <strong>Down Payment:</strong> 10-20% typical ($140K-$280K)</li>

                <li>â€¢ <strong>Popular Programs:</strong> Conventional, Jumbo, Investment property loans</li>

                <li>â€¢ <strong>Credit Score:</strong> 720+ recommended for best rates</li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>â€¢ <strong>Loan Amount:</strong> $2.8M average (super jumbo territory)</li>

                <li>â€¢ <strong>Down Payment:</strong> 20-30% typical ($560K-$840K)</li>

                <li>â€¢ <strong>Popular Programs:</strong> Jumbo, Super Jumbo, Portfolio loans</li>

                <li>â€¢ <strong>Credit Score:</strong> 740+ essential for luxury market</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ Continued strong demand from tech workers</li>

                <li>â€¢ New construction in Great Park area</li>

                <li>â€¢ Stable appreciation (3-5% annually expected)</li>

                <li>â€¢ Strong rental market for investors</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ Limited inventory keeping prices high</li>

                <li>â€¢ Luxury market showing resilience</li>

                <li>â€¢ Waterfront properties premium increasing</li>

                <li>â€¢ International buyer interest remains strong</li>
