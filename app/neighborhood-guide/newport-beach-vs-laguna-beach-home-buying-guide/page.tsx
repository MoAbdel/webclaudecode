...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/neighborhood-guide/newport-beach-vs-laguna-beach-home-buying-guide", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center text-sm text-slate-500 mb-4">
            ...
            <span>Published January 22, 2025 â€¢ By Mo Abdel, Orange County Mortgage Broker</span>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold mb-3 text-blue-600">âœ… Why Choose Newport Beach</h3>

                <ul className="space-y-2 text-slate-700">

                  <li>â€¢ <strong>Harbor lifestyle:</strong> Balboa Island, world-class marina, boating</li>

                  <li>â€¢ <strong>Luxury amenities:</strong> Fashion Island, high-end shopping and dining</li>

                  <li>â€¢ <strong>Better schools:</strong> Corona del Mar High, stronger school districts</li>

                  <li>â€¢ <strong>Investment strength:</strong> Historically stronger appreciation</li>

                  <li>â€¢ <strong>Business hub:</strong> Close to major employers and airports</li>

                  <li>â€¢ <strong>Beach variety:</strong> Multiple beaches, from family to upscale</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-700">
                  ...
                  <li>â€¢ Higher prices and living costs</li>

                  <li>â€¢ More crowded, especially summer</li>

                  <li>â€¢ Less artistic/bohemian character</li>

                  <li>â€¢ Traffic congestion issues</li>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold mb-3 text-purple-600">âœ… Why Choose Laguna Beach</h3>

                <ul className="space-y-2 text-slate-700">

                  <li>â€¢ <strong>Artistic community:</strong> Gallery walks, Pageant of Masters, art festivals</li>

                  <li>â€¢ <strong>Natural beauty:</strong> Dramatic coastline, coves, scenic views</li>

                  <li>â€¢ <strong>Unique character:</strong> Bohemian charm, historic downtown</li>

                  <li>â€¢ <strong>Better value:</strong> $600K less than Newport Beach on average</li>

                  <li>â€¢ <strong>Walkable village:</strong> Everything within walking distance</li>

                  <li>â€¢ <strong>Privacy:</strong> More secluded, intimate community feel</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-700">
                  ...
                  <li>â€¢ Longer commute to business centers</li>

                  <li>â€¢ Limited parking and narrow streets</li>

                  <li>â€¢ Fewer luxury amenities nearby</li>

                  <li>â€¢ Hillside living may not suit everyone</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ Historically stronger appreciation rates</li>

                <li>â€¢ Higher rental income potential</li>

                <li>â€¢ More liquid luxury market</li>

                <li>â€¢ Business/employment proximity drives demand</li>

                <li>â€¢ International buyer interest</li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ Unique character preserves value</li>

                <li>â€¢ Limited inventory supports prices</li>

                <li>â€¢ Strong vacation rental market</li>

                <li>â€¢ Artist community maintains desirability</li>

                <li>â€¢ Better entry point than Newport Beach</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>â€¢ <strong>Loan Amount:</strong> $2.8M average (super jumbo)</li>

                <li>â€¢ <strong>Down Payment:</strong> 20-30% typical ($560K-$840K)</li>

                <li>â€¢ <strong>Popular Programs:</strong> Super jumbo, Portfolio, Bank statement</li>

                <li>â€¢ <strong>Credit Score:</strong> 740+ essential for best rates</li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>â€¢ <strong>Loan Amount:</strong> $2.2M average (super jumbo)</li>

                <li>â€¢ <strong>Down Payment:</strong> 20-25% typical ($440K-$550K)</li>

                <li>â€¢ <strong>Popular Programs:</strong> Super jumbo, Asset-based loans</li>

                <li>â€¢ <strong>Credit Score:</strong> 740+ required for luxury market</li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ You want the ultimate luxury lifestyle</li>

                <li>â€¢ Business networking is important</li>

                <li>â€¢ You prefer modern amenities and conveniences</li>

                <li>â€¢ Investment appreciation is a priority</li>

                <li>â€¢ You enjoy boating and marina life</li>

                <li>â€¢ School quality is important</li>
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li>â€¢ You appreciate art and creative culture</li>

                <li>â€¢ You want a more intimate community</li>

                <li>â€¢ Natural beauty is your top priority</li>

                <li>â€¢ You prefer unique, character homes</li>

                <li>â€¢ You want better value in luxury market</li>

                <li>â€¢ Walkability and village life appeal to you</li>
