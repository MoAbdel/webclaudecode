...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/neighborhood-guide/orange-county-neighborhoods-comparison-guide" },
    openGraph: { title, description, url: BASE + "/neighborhood-guide/orange-county-neighborhoods-comparison-guide", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center text-sm text-slate-500 mb-4">
            ...
            <span>Published June 5, 2025 â€¢ By Mo Abdel, Orange County Mortgage Broker</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-700 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-blue-100">
                ...
                <li>â€¢ Conventional loans available</li>

                <li>â€¢ FHA possible in some areas</li>

                <li>â€¢ 5-10% down payment options</li>

                <li>â€¢ First-time buyer programs</li>
            ...
            <div className="bg-blue-700 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-blue-100">
                ...
                <li>â€¢ Jumbo loans required</li>

                <li>â€¢ 10-20% down typical</li>

                <li>â€¢ Portfolio loan options</li>

                <li>â€¢ Investment property financing</li>
            ...
            <div className="bg-blue-700 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-blue-100">
                ...
                <li>â€¢ Super jumbo specialists</li>

                <li>â€¢ 20-30% down required</li>

                <li>â€¢ Bank statement programs</li>

                <li>â€¢ International buyer options</li>
