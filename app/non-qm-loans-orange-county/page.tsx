...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/non-qm-loans-orange-county" },
    openGraph: { title, description, url: BASE + "/non-qm-loans-orange-county", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3">
                  ...
                  <span className="text-xl font-bold text-blue-600">4-5 Weeks</span>
