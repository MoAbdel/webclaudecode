...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: { title, description, url: BASE + "/", siteName: "Mo Abdel â€” Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
...
const RateDisplay = nextDynamic(() => import('@/components/home/RateDisplay'), {

  loading: () => <div className="h-32 bg-slate-50 animate-pulse rounded-lg" />

});

const LocalMarketInsights = nextDynamic(() => import('@/components/home/LocalMarketInsights'), {
...
export default function HomePage() {
  ...
  return (
    <>
      <h1 className="sr-only">Orange County, CA Mortgage Broker â€” Home Loans & Refinance</h1>
      ...
      {(() => {
        const personSchema = {
          ...
          "brand": "Mo Abdel â€” Mortgage Broker",
