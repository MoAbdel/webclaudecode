...
export const metadata: Metadata = {
  title: 'Conventional Loans Orange County | 3% Down Payment | Mo The Broker NMLS #1426884',
  description: 'Conventional loans in Orange County with competitive rates and flexible terms. 3% down payment options available. Licensed broker with NEXA Mortgage. Call (949) 579-2057.',
