...
export const metadata: Metadata = {
  title: 'FHA Loans Orange County | 3.5% Down Payment | Mo The Broker NMLS #1426884',
  description: 'FHA loans in Orange County with just 3.5% down payment. Government-backed mortgages with flexible credit requirements. Licensed broker with NEXA Mortgage. Call (949) 579-2057.',
