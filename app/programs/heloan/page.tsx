...
export const metadata: Metadata = {
  title: 'HELOAN (Home Equity Loan) - Orange County | Mo The Broker',
  description: 'Get a fixed-rate Home Equity Loan in Orange County. Lump sum up to $500K with predictable payments. Licensed broker with NEXA Mortgage. Call (949) 579-2057.',
