...
export const metadata: Metadata = {
  title: 'Non-QM Loans Orange County | Alternative Income Documentation | Mo The Broker',
  description: 'Non-QM loans in Orange County for self-employed, investors, and unique income situations. Bank statements, asset-based, and alternative documentation programs. Call (949) 579-2057.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <table className="w-full bg-white rounded-lg shadow-lg">
              ...
              <tbody className="divide-y divide-slate-200">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-center text-orange-600">45-60 days</td>
                  <td className="px-6 py-4 text-center text-blue-600 font-bold">21-30 days</td>
                </tr>
                <tr className="bg-slate-50">
        ...
        <div className="text-center bg-gradient-to-r from-orange-600 to-orange-700 rounded-2xl p-8 text-white">
          ...
          <p className="text-sm text-orange-200 mt-4">
            Licensed broker with NEXA Mortgage • NMLS #1426884 • Non-QM lending specialist
          </p>
        </div>
      </div>
    </div>
