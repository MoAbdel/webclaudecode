...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/resources/glossary" },
    openGraph: { title, description, url: BASE + "/resources/glossary", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
...
export default function GlossaryPage() {
  const glossaryTerms = [
    ...
    {
      term: 'HELOC',
      definition: 'HELOC - a revolving credit line secured by home equity, allowing borrowers to access funds as needed up to a credit limit.',
      category: 'Loan Types',
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Glossary | Mo Abdel","mainEntityOfPage":"https://www.mothebroker.com/resources/glossary","author":{"@type":"Person","name":"Mo Abdel"},"publisher":{"@type":"Organization","name":"Mo Abdel — Mortgage Broker","logo":{"@type":"ImageObject","url":"https://www.mothebroker.com/logo.png"}},"image":"https://www.mothebroker.com/logo.png"})
}} />
</div>
  );
}
