...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/resources/service-providers" },
    openGraph: { title, description, url: BASE + "/resources/service-providers", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({"@context":"https://schema.org","@type":"Article","headline":"Service Providers | Mo Abdel","mainEntityOfPage":"https://www.mothebroker.com/resources/service-providers","author":{"@type":"Person","name":"Mo Abdel"},"publisher":{"@type":"Organization","name":"Mo Abdel — Mortgage Broker","logo":{"@type":"ImageObject","url":"https://www.mothebroker.com/logo.png"}},"image":"https://www.mothebroker.com/logo.png"})
}} />
</div>
  );
}
