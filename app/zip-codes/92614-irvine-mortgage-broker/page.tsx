...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/zip-codes/92614-irvine-mortgage-broker" },
    openGraph: { title, description, url: BASE + "/zip-codes/92614-irvine-mortgage-broker", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
