...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/zip-codes/92625-corona-del-mar-mortgage-broker" },
    openGraph: { title, description, url: BASE + "/zip-codes/92625-corona-del-mar-mortgage-broker", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
