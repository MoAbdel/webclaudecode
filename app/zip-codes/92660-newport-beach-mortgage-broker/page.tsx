...
export async function generateMetadata() {
  ...
  return {
    title,
    description,
    alternates: { canonical: BASE + "/zip-codes/92660-newport-beach-mortgage-broker" },
    openGraph: { title, description, url: BASE + "/zip-codes/92660-newport-beach-mortgage-broker", siteName: "Mo Abdel — Mortgage Broker", images: ["https://www.mothebroker.com/logo.png"] },
