...
export default function CityPageTemplate({ cityData }: CityPageProps) {
  ...
  const structuredFAQ = [
    ...
    },
    {
      ...
      answer: `Mortgage rates in ${cityData.name} vary based on loan type, credit score, and down payment. Current rates start around 6.5% for 30-year fixed loans. Contact Mo for personalized rate quotes based on your specific situation.`
    },
    {
