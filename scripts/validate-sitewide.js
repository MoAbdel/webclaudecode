...
const REPORT = "reports/sitewide-validation.md";
...
const md = [
  ...
  "|------|------|----------:|:--------|----------:|:-------|:--------|:---------|:--------|:---------|:-------|",
  ...rows.map((r) =>
    `| ${r.path} | ${r.type} | ${r.titlePx} | ${r.titleOk ? "✅" : "❌"} | ${r.descLen} | ${r.descOk ? "✅" : "❌"} | ${r.canonOk ? "✅" : "❌"} | ${r.schemaOk ? "✅" : "❌"} | ${r.linksOk ? "✅" : "❌"} | ${r.limitsOk ? "✅" : "❌"} | ${r.result} |`
  )
].join("\n");
